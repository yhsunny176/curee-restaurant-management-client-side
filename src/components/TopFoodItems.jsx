...
import { FadeInFromLeft, FadeInText, FadeInCard } from "./ScrollAnimations";
        ...
        <div>
            ...
            <div>
                {loading ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mx-auto max-w-11/12 lg:max-w-10/12 xl:max-w-9/12 2xl:max-w-8/12">
                            {topFoods.map((food, index) => (
                                <FadeInCard key={food._id} delay={index * 0.1}>
                        ...
                        <div className="flex justify-center items-center pb-32 mt-8">
                            <FadeInCard>
                                <Link
                                    to="/all-foods"
                                    className="px-4 sm:px-6 md:px-8 lg:px-10 py-2.5 md:py-3 lg:py-3.5 text-sm sm:text-base md:text-lg lg:text-xl text-white-text-primary bg-red-base rounded-md hover:bg-red-dark transition-colors duration-600 ease-in-out whitespace-nowrap min-h-[44px] flex items-center justify-center">
                                    See All
                                </Link>
                            </FadeInCard>
                        </div>
