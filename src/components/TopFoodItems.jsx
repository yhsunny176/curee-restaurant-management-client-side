        ...
        <div>
            ...
            <div className="max-w-8/12 mx-auto py-32 flex gap-6">
                ...
                <div className="text-top-food w-6/12 space-y-6">
                    <p className="font-pg font-medium text-xl text-red-text-500">Top Food Items</p>
                    <div className="space-y-8">
                        <h1 className="text-5xl leading-h1 text-black-text-500">
                            Curated Signatures, Crafted to Be Remembered
                        </h1>
                        <p className="leading-p1 text-black-text-100 mt-2">
